...
SEGMENT_NAME = "CD"
STACK_SIZE = 10  # numbers of drop copy in buffer before writing to file (THREADSHOLD FOR WRITING IN FILE)
VAR_LOGGING = True  # True to log and False to not log
SOCKET_TIMEOUT = 2  # socket timeout in seconds
STACK_TIMER = 1  # seconds
NOTIS_FORMAT = False  # if it is true then output will be on notis format else in dropcopy format
